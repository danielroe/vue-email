        ...
        <e-section class="w-[580px] my-0 mx-auto">
          <e-row>
            <e-column align="right" class="w-[50%] pr-[8px]">
              <e-img src="/twitch-icon-twitter.png" />
            </e-column>
            <e-column align="left" class="w-[50%] pr-[8px]">
              <e-img src="/twitch-icon-facebook.png" />
            </e-column>
          </e-row>
